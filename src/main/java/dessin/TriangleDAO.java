...
public class TriangleDAO implements CustomDAO<Triangle> {
	...
	public int insertCustomer(Triangle t) {
		...
		try (Connection connect = derby.createConnection()) {
			try {
				prepare = connect
						.prepareStatement("INSERT INTO Triangle (nom, coord1, coord2, coord3, coord4, coord5, coord6)"
								+ "VALUES (?, ?, ?, ?, ?, ?, ?)");
	...
	public void findAllCustomer() {
		...
		try (Connection connect = derby.createConnection()) {
			try {
				prepare = connect
						.prepareStatement("SELECT nom, coord1, coord2, coord3, coord4, coord5, coord6 FROM Triangle ");
