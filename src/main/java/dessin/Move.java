...
public class Move implements Command {
	...
	/****
	 * Initialisation de la commande move avec les paramètres de l'élément a deplacer
			...
			for (int i = 0; i < elementGroup.size(); i++) 
			{
				...
				else
				{
					...
					else
					{
						...
						if(rectangle!=null)
						{
							derby.getRectangleDAO().move(rectangle, Integer.parseInt(list.get(2)), Integer.parseInt(list.get(3)));						
						}
						else
						{
							...
							if(triangle!=null)
							{
								derby.getTriangleeDAO().move(triangle, Integer.parseInt(list.get(2)), Integer.parseInt(list.get(3)));
							}
							else
							{
